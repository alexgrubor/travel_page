<?php 
  ...
  //images dirs
  define("COUNTRIESIMAGES", "http://localhost/travel/admin-panel/countries-admins/images_countries");
  define("CITIESIMAGES", "http://localhost/travel/admin-panel/cities-admins/images_cities");
            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <a href="<?php echo APPURL; ?>" class="logo">
                        <img src="<?php echo APPURL; ?>/assets/images/logo.jpg" alt="">
                    </a>
                    <!-- ***** Logo End ***** -->
                    <!-- ***** Menu Start ***** -->
                    <ul class="nav">
